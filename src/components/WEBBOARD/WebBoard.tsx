...
const WebBoard: React.FC = () => {
  const posts = [
    { id: 1, title: "กระทู้ที่ 1" },
    { id: 2, title: "กระทู้ที่ 2" },
    { id: 3, title: "กระทู้ที่ 3" },
  ];

  return (
    <div className="flex flex-col items-center bg-transparent text-white w-full min-h-screen p-6">
      {/* ปุ่มสร้างกระทู้ */}
      ...
      {/* หัวข้อ */}
      <h1 className="text-3xl font-bold text-purple-500 mb-6 rounded-lg">
        กระทู้
       </h1>
